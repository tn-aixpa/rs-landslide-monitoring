...
cd /app
echo "{'s1_ascending': '$1', 's1_descending': '$2', 'outputArtifactName': '$3', 'shapeArtifactName': '$4', 'shapeFileName': '$5'}"
...
echo $PROJ_LIB
python job_insar_preprocessing.py "{'s1_ascending': '$1', 's1_descending': '$2', 'outputArtifactName': '$3', 'shapeArtifactName': '$4', 'shapeFileName': '$5'}"
exit